...
<body class="smooth-scroll bg-warm-cream text-deep-brown">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Previous Button -->
        <button id="prevBtnPackages" class="absolute left-0 sm:-left-2 md:-left-4 top-1/2 transform -translate-y-1/2 z-10 bg-rich-brown text-warm-cream w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-deep-brown transition-all duration-300 focus:outline-none">
        ...
        <!-- Next Button -->
        <button id="nextBtnPackages" class="absolute right-0 sm:-right-2 md:-right-4 top-1/2 transform -translate-y-1/2 z-10 bg-rich-brown text-warm-cream w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-deep-brown transition-all duration-300 focus:outline-none">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
        </button>
