                        ...
                        <div class="bg-deep-brown/50 rounded-3xl p-8 shadow-2xl">
                            <div class="bg-warm-cream rounded-2xl p-8">
                                ...
                                <div class="mt-8 space-y-3">
                                    ...
                                    <button class="w-full border-2 border-deep-brown text-rich-brown py-3 rounded-xl font-baskerville font-bold hover:bg-deep-brown hover:text-warm-cream transition-all duration-300">
                                        Get Directions
                                    </button>
                                </div>
                            </div>
