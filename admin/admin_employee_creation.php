                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex space-x-3">
                                <button id="view-archived-btn" class="group w-10 hover:w-40 h-10  bg-warm-cream/100 hover:from-rich-brown hover:to-deep-brown text-warm-cream rounded-lg transition-all duration-500 flex items-center justify-center overflow-hidden shadow-md hover:shadow-lg font-baskerville">
                                ...
                                <button id="create-cashier-btn" class="group w-10 hover:w-40 h-10  bg-warm-cream/100 hover:from-rich-brown hover:to-deep-brown text-warm-cream rounded-lg transition-all duration-500 flex items-center justify-center overflow-hidden shadow-md hover:shadow-lg font-baskerville">
                            ...
                            <?php foreach ($cashiers as $cashier): ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="p-4 flex justify-center space-x-3">
                                        <!-- Edit Button -->
                                        <button class="group edit-btn w-8 hover:w-32 h-8 bg-warm-cream/80 text-rich-brown hover:text-deep-brown rounded-full transition-all duration-300 ease-in-out flex items-center justify-center overflow-hidden transform hover:scale-105" data-id="<?php echo htmlspecialchars($cashier['id']); ?>">
