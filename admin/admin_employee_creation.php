                            ...
                            <?php foreach ($cashiers as $cashier): ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="p-4 flex justify-center space-x-3">
                                        <!-- Edit Button -->
                                        <button class="group edit-btn w-8 hover:w-25 h-8 bg-warm-cream/80 text-rich-brown hover:text-deep-brown rounded-full transition-all duration-300 ease-in-out flex items-center justify-center overflow-hidden transform hover:scale-105" data-id="<?php echo htmlspecialchars($cashier['id']); ?>">
                                        ...
                                        <!-- Archive Button -->
                                        <button class="group archive-btn w-8 hover:w-25 h-8 bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 hover:text-blue-500 rounded-full transition-all duration-300 ease-in-out flex items-center justify-center overflow-hidden transform hover:scale-105" data-id="<?php echo htmlspecialchars($cashier['id']); ?>">
