        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6 md:p-8 lg:p-10 relative z-0">
                <div class="dashboard-card fade-in bg-white/90 backdrop-blur-md rounded-xl shadow-lg p-6 md:p-8 max-w-7xl mx-auto">
                    ...
                    <table class="w-full table-auto display nowrap bg-white" style="width:100%">
                            <thead>
                                <tr>
...
<div id="create-cashier-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 transition-opacity duration-300 modal modal-hidden px-4 sm:px-6">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-auto transform transition-all duration-300 overflow-y-auto max-h-[90vh] sm:max-h-[95vh]">
        <div class="flex justify-between items-center bg-amber-800 text-white p-4 sm:p-5 rounded-t-xl sticky top-0">
            <h3 class="text-lg sm:text-xl md:text-2xl font-semibold">Create New Cashier</h3>
            <button id="close-modal" class="text-white hover:text-gray-200 transition-colors duration-200 text-xl">
                <i class="fas fa-times"></i>
            </button>
        </div>
        
        <form id="cashier-form" class="p-4 sm:p-6 md:p-8" method="POST" action="">
            <input type="hidden" name="form_type" value="cashier">
            <?php if (!empty($errors) && isset($_POST['form_type']) && $_POST['form_type'] === 'cashier'): ?>
                <div class="bg-red-50 border-l-4 border-red-500 text-red-700 p-3 sm:p-4 rounded-lg mb-4 sm:mb-6" role="alert">
                    <div class="flex items-center">
                        <i class="fas fa-exclamation-circle mr-2"></i>
                        <strong class="font-semibold">Error!</strong>
                    </div>
                    <span class="block mt-1 text-sm sm:text-base">Please fix the following issues:</span>
            ...
            <?php if ($registration_success): ?>
                <div class="bg-green-50 border-l-4 border-green-500 text-green-700 p-3 sm:p-4 rounded-lg mb-4 sm:mb-6" role="alert">
                    <div class="flex items-center">
                        <i class="fas fa-check-circle mr-2"></i>
                        <strong class="font-semibold">Success!</strong>
                    </div>
                    <span class="block mt-1 text-sm sm:text-base">Cashier registration successful!</span>
                </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
                <div class="input-group">
                    ...
                    <input type="text" id="fname" name="fname" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base" required>
                    <div class="field-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></div>
                </div>
                <div class="input-group">
                    <label for="mname" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Middle Name</label>
                    <input type="text" id="mname" name="mname" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base">
                </div>
                <div class="input-group">
                    <label for="lname" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Last Name *</label>
                    <input type="text" id="lname" name="lname" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base" required>
                    <div class="field-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></div>
                </div>
                <div class="input-group">
                    <label for="suffix" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Suffix</label>
                    <select id="suffix" name="suffix" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base">
                ...
                <div class="input-group col-span-2">
                    <label for="username" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Username *</label>
                    <input type="text" id="username" name="username" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base" required>
                    <p class="username-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></p>
                    <div class="field-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></div>
                </div>
                <div class="input-group col-span-2">
                    <label for="phone" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Phone Number *</label>
                    <input type="tel" id="phone" name="phone" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base" required>
                    <p class="phone-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></p>
                    <div class="field-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></div>
                </div>
                <div class="input-group col-span-1">
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base" required>
                        <button type="button" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-amber-700 toggle-password" data-target="password">
                            <i class="fas fa-eye text-sm sm:text-base"></i>
                        </button>
                    </div>
                    <p class="password-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></p>
                ...
                <div class="input-group col-span-1">
                    <label for="confirm-password" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Confirm Password *</label>
                    <div class="relative">
                        <input type="password" id="confirm-password" name="confirm-password" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm sm:text-base" required>
                        <button type="button" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-amber-700 toggle-password" data-target="confirm-password">
                            <i class="fas fa-eye text-sm sm:text-base"></i>
                        </button>
                    </div>
                    <p class="confirm-password-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></p>
                    <div class="field-feedback mt-1 text-xs sm:text-sm text-red-600 hidden"></div>
                </div>
            </div>
            
            <div class="mt-6 sm:mt-8 flex flex-col-reverse sm:flex-row justify-end space-y-3 space-y-reverse sm:space-y-0 sm:space-x-4">
                <button type="button" id="cancel-btn" class="px-4 py-2 sm:px-5 sm:py-2.5 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors duration-300 font-medium text-sm sm:text-base">
                    Cancel
                </button>
                <button type="submit" id="submit-btn" class="px-4 py-2 sm:px-5 sm:py-2.5 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors duration-300 font-medium text-sm sm:text-base" disabled>
                    Create Cashier
                </button>
            </div>
        </form>
