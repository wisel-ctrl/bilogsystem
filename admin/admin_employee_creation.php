                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex space-x-3">
                                <button id="view-archived-btn" class="group w-10 hover:w-40 h-10  bg-warm-cream/100 hover:from-rich-brown hover:to-deep-brown text-rich-brown rounded-lg transition-all duration-300 flex items-center justify-center overflow-hidden shadow-md hover:shadow-lg font-baskerville">
                                ...
                                <button id="create-cashier-btn" class="group w-10 hover:w-40 h-10  bg-warm-cream/100 hover:from-rich-brown hover:to-deep-brown text-rich-brown rounded-lg transition-all duration-300 flex items-center justify-center overflow-hidden shadow-md hover:shadow-lg font-baskerville">
