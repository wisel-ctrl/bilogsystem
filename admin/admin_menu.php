        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-y-auto p-6 md:p-8 lg:p-10 relative z-0">
                    ...
                    <!-- MODAL SECTION - Outside main-wrapper -->
                    <!-- Dish Creation Modal -->
                    <div id="dish-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden z-[9999] flex items-center justify-center p-4">
                        <div class="dashboard-card rounded-lg max-w-2xl w-full modal-container bg-white shadow-xl">
...
<script>
    ...
    function applyBackgroundBlur() {
        ...
        mainWrapper.classList.add('blur-sm', 'transition-all', 'duration-300');
    }

    function removeBackgroundBlur() {
        const mainWrapper = document.getElementById('main-wrapper');
        mainWrapper.classList.remove('blur-sm', 'transition-all', 'duration-300');
    }
