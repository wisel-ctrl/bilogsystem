...
<div id="sidebar" class="bg-gradient-to-b from-deep-brown via-rich-brown to-accent-brown text-warm-cream transition-all duration-300 ease-in-out w-64 flex-shrink-0 shadow-2xl">
    ...
    <nav class="px-4">
        <ul class="space-y-2">
            ...
            <li>
                <a href="admin_bookings.php" class="sidebar-link <?php echo basename($_SERVER['PHP_SELF']) === 'admin_bookings.php' ? 'active' : ''; ?> flex items-center space-x-3 p-3 rounded-lg hover:bg-warm-cream/20 text-warm-cream/80 hover:text-warm-cream transition-all duration-200">
