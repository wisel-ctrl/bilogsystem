...
<body class="smooth-scroll bg-warm-cream text-deep-brown">
    ...
    <section id="best-seller" class="pt-20 pb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 animate-fade-in">
                <h1 class="font-playfair text-4xl sm:text-5xl md:text-6xl font-extrabold text-deep-brown mb-4 tracking-tight">Best-Seller Menu</h1>
                ...
                <p class="font-baskerville text-lg sm:text-xl text-rich-brown/80 max-w-3xl mx-auto leading-relaxed">
                    Discover the crowd favorites that keep our guests coming back. Each best-seller is a perfect blend of flavor, freshness, and satisfaction.
                </p>
            </div>
