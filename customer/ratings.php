            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex flex-1 justify-center space-x-8">
                    ...
                    <a href="#contact" class="font-baskerville hover:text-deep-brown/80 transition-colors duration-300 relative group">
                        Contact
                        <span class="absolute bottom-0 left-0 w-full h _

System: <xaiArtifact artifact_id="bb015f05-964c-4997-84a2-63680e6a26de" artifact_version_id="041bf48a-f1a4-4b41-bf1d-f98cc465d0d2" title="ratings.php" contentType="text/html">
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
