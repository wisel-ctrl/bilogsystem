                        ...
                        data.data.forEach(package => {
                            ...
                            menuItem.innerHTML = `
                                ...
                                <div class="menu-card-content p-6">
                                    <h4 class="font-playfair text-2xl font-bold mb-3 text-deep-brown pr-20">
                                        ${package.package_name || 'Menu Item'}
                                    </h4>
                                    <p class="font-baskerville text-deep-brown/80 menu-card-description mb-4 line-clamp-3">
                                    ...
                                    <div class="menu-card-footer">
                                        ...
                                        <button class="reserve-btn btn-primary w-full bg-gradient-to-r from-rich-brown to-amber-600 text-warm-cream rounded-lg font-baskerville py-3 hover:from-deep-brown hover:to-amber-700 transition-all duration-300 group shadow-md"
